...
extension NSManagedObjectContext {
    typealias NotificationComletion = (ObjectsDidChangeNotification) -> Void

    func objectDidChangeNotificationObserver(_ completion: @escaping NotificationComletion) -> NSObjectProtocol {
        let notification = NotificationCenter.default
        return notification.addObserver(forName: NSNotification.Name.NSManagedObjectContextObjectsDidChange,
                                        object: self,
                                        queue: nil,
                                        using: {
